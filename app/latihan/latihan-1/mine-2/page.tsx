        ...
        <div className="bg-white w-full min-h-screen overflow-x-hidden">
            ...
            <div className="pt-20 pb-10 sm:pb-20 md:pb-30 lg:pb-40 flex flex-col w-full justify-center">
                ...
                <div className="py-10 sm:py-20 md:py-30 lg:py-40 flex flex-col text-center">
                    {content.map(c => (
                        <h1 key={c.id} className="font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-gray-800">{c.text}</h1>
                    ))}
                </div>
                ...
                <div className="flex-col sm:flex-row flex justify-center gap-5 sm:gap-0">
                    ...
                    text-gray-800 border-3 hover:bg-gray-800 duration-500 hover:border-gray-800
                    border-gray-200 hover:border-blue-200 rounded-sm font-bold">
                        Sign Up
                    </button>
                    <button className="py-4 px-15 hover:px-20 mx-10 hover:mx-5 hover:text-white
                    text-gray-800 border-3 hover:bg-gray-800 duration-900 hover:border-gray-800
                    border-gray-200 hover:border-blue-200 rounded-sm font-bold">
                        Sign In
                    </button>
                </div>
                ...
                {/* CARD */}
                <div className="justify-between gap-6 sm:gap-11 md:gap-16 lg:gap-21 grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 mx-auto mt-20 mb-20">
                    {cardCompany.map(cc =>(
                        <div key={cc.id}  className="bg-red-200  h-48 w-40 sm:h-90 sm:w-70 rounded-lg shadow-lg ">
                            <div className="bg-gray-300  w-full h-34 sm:h-70 rounded-t-lg">

                            </div>
                            <div className="bg-gray-800 w-full h-14 sm:h-20 rounded-b-lg  py-1 px-2  sm:p-3">
                                <h1 className="text-md sm:text-2xl">{cc.title}</h1>
                                <h1 className="text-sm sm:text-xl">{cc.sub}</h1>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <footer className="bg-gray-800 w-full h-100 p-5 sm:py-20 sm:px-40 flex flex-col">
                ...
                <div className="flex  justify-between flex-col sm:flex-row text-white gap-5 sm:gap-0">
                    <div className="flex flex-col w-full sm:w-200">
